...
package body AoC_Common.Grids is
   ...
   function Create (Rows : Row_Range; Cols : Col_Range) return Grid_Type is
   begin
      return
        (Rows => Rows,
         Cols => Cols,
   ...
   function Get
     (G : Grid_Type; Row : Positive; Col : Positive) return Element_Type is
   begin
      return G.Data (Row, Col);
   end Get;

   function Get (G : Grid_Type; Pos : Coordinate) return Element_Type is
   begin
