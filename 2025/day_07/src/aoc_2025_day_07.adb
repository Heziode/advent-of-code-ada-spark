...
with Ada.Text_IO;
with Resources;
with Aoc_2025_Day_07_Config;
with AoC_2025_Day_07.Solver;
...
is
   ...
   package Day_Resources is new Resources (Aoc_2025_Day_07_Config.Crate_Name);
