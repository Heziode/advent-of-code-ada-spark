...
with AoC_2025_Day_10.Solver;
with Resources;
with Aoc_2025_Day_10_Config;

package body AoC_2025_Day_10 with SPARK_Mode => Off is

   ---------------------------------------------------------------------------
   --  Resource Path Helper
   ---------------------------------------------------------------------------

   package Day_Resources is new Resources (Aoc_2025_Day_10_Config.Crate_Name);
